...
function SchnelleingabeScreen({ ves, setVes, kontakte, t, accent, settings = null,
  ...
  // Die Einheit-Nr. ist die FIXE erste Spalte (sticky links) — NICHT mehr im
  // wählbaren Katalog (frühere Doppelung „Einheit"(fix) + „Nr."(wählbar)).
  // Im Bearbeiten-Modus wird die fixe Spalte über zellInput editierbar.
  const SPALTE_NR_FIX = { id: "nr", label: "Einheit", breite: 90, art: "text" };
              ...
              <thead>
                <tr style={{ background: t.surface }}>
                  <th style={{ textAlign: "left", padding: "10px 12px",
                    ...
                    minWidth: 90, whiteSpace: "nowrap" }}>Einheit</th>
                  {spalten.map(sid => {
